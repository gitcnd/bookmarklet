...
Supports: ChatGPT, Perplexity, DeepSeek, OpenRouter, Claude, Gemini, Google AI Studio, X.com, Grok, Microsoft Copilot, Microsoft 365 Copilot, Teams (meeting transcripts), WhatsApp Web, Z.ai, and Qwen!
